...
def update_naked_twins(values,peers,twins,box):
...
def naked_twins(values):
    ...
    for box in twoDigitBoxes: 
        ...
        twins_col = [x for x in col_peers if values[x]==values[box] and len(values[x])>1]
        ...
        print('TWINS !!!!!!!  yeah !')
        if len(twins_col)>0:
            values=update_naked_twins(values,col_peers,twins_col,box) 
        display(values)
        print('+++++++++++++++++++++++ COL OUT ++++++++++++++++++++++++++++++++++++++++')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS rows  IN >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        ...
        if len(twins_row)>0:
            values=update_naked_twins(values,row_peers,twins_row,box) 
        display(values)
        print('- - - - - - - - - - - - - - - - - - - - - - - - - - -')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS row OUT  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS SQUARE IN  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        sqr_peers=[x for x in values if x in square_units and x != box]
        ...
        if len(twins_sqr)>0:
            values=update_naked_twins(values,sqr_peers,twins_sqr,box) 
        display(values)
        print('- - - - - - - - - - - - - - - - - - - - - - - - - - -')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS SQUARE OUT  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS DIAGS IN >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        diag1_peers=[x for x in values if x in diag1 and x != box]
        print(diag1_peers)   
        #now find diagonal twins
        twins_diag1 = [x for x in diag1_peers if values[x]==values[box]]
        print('TWINS DIAG1 COUNT=%r'%(len(twins_diag1)))
        if len(twins_diag1)==0:
            print('no twins :-((((((((((((((((((((((((((((((((((((((((((((((((  :-(  ')
            return values
        print('TWINS DIAG1 !!!!!!!  yeah !::  ',box,values[box])
        if len(twins_diag1)>0:
            values=update_naked_twins(values,diag1_peers,twins_diag1,box)   
        display(values)
        print('- - - - - - - - - - - - - - - - - - - - - - - - - - -')
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS DIAGS2 IN >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
        diag2_peers=[x for x in values if x in diag2 and x != box]
        print(diag2_peers)
        
        #now find diagonal twins
        twins_diag2 = [x for x in diag2_peers if values[x]==values[box]]
        print('TWINS ROW COUNT=%r'%(len(twins_diag2)))
        if len(twins_diag2)==0:
            print('no twins :-((((((((((((((((((((((((((((((((((((((((((((((((  :-(  ')
            return values
        print('TWINS !!!!!!!  yeah !::  ',box,values[box])
        if len(twins_diag2)>0:
            values=update_naked_twins(values,diag2_peers,twins_diag2,box)     
        display(values)
        print('- - - - - - - - - - - - - - - - - - - - - - - - - - -')
        #display(values)
        print('xxxxxxxxxxxxxxxxxxxxxxxxxxx TWINS Diag1 OUT  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>')
    return values
